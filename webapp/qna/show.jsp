		...
		<div class="panel panel-default">
			<header class="qna-header">
				...
				<form class="form-delete" action="/qna/delete" method="post">
                    <input type="hidden" name="questionId" value="${question.questionId}">
                    <button type="submit" class="link-delete-question">삭제(redirect)</button>
                </form>
                <form class="form-delete" action="/api/qna/deleteQuestion" method="post">
                <input type="hidden" name="questionId" value="${question.questionId}">
                <button type="submit" class="link-delete-question">삭제(json)</button>
                </form>
			</header>
			<div class="content-main">
				...
				<div class="qna-comment">
					<div class="qna-comment-slipp">
						<p class="qna-comment-count" id="qna-comment-count"><strong>${question.countOfComment}</strong>개의 의견</p>
